...
- The connection to the cloud now uses the Exchange Online PowerShell V2 module. See '.\README' for details about the required 'ExchangeOnlineConnnectionParameters' parameter.
### Fixed
- XXX
